...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    'general.noResultsForSearch': 'araması için sonuç bulunamadı.',
  ...
  en: {
    ...
    'general.resourceSearchNoResults': 'No Search Results Found',
    ...
    'general.noResultsForSearch': 'No results found for search.',
