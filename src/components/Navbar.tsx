      ...
      <div>
                        ...
                        className={`group flex items-center space-x-1 px-3 py-1.5 rounded-lg text-sm transform transition-all duration-500 ${
                          pathname === '/' && isScrolled
                            ...
                            : pathname === link.href
                              ...
                              : (pathname === '/' ? 'text-white/90 font-semibold hover:text-[#FFD6B2] hover:bg-[#994D1C]/80 hover:-translate-y-1 hover:shadow-lg' : (link.href === '/ilanlar' || link.href === '/kaynaklar' || link.href === '/projeler' || link.href === '/kulupler')
        ...
        {isMobile && isMenuOpen && (
          <>
            ...
            />
            {/* Slide-in Panel */}
            <div className="fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white z-[60] shadow-xl md:hidden transition-transform duration-300 translate-x-0 flex flex-col">
