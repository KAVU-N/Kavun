...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-[#FFF5F0] to-white border-t border-[#FFE5D9] mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-[#6B3416]">
                KAVUN
              </span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/blog" className="text-[#994D1C] hover:text-[#FF8B5E] transition-colors duration-300">
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="tel:+901234567890" className="text-[#994D1C] hover:text-[#FF8B5E] transition-colors duration-300">
                  +90 (123) 456 7890
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-[#FFE5D9]">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="mt-4 md:mt-0">
              <div className="flex space-x-6">
                <a href="#" className="text-sm text-[#994D1C] hover:text-[#FF8B5E] transition-colors duration-300">
                  Destek
                </a>
                <a href="#" className="text-sm text-[#994D1C] hover:text-[#FF8B5E] transition-colors duration-300">
                  Güvenlik
