  ...
  return (
    <div className="relative min-h-screen overflow-hidden pt-28 pb-12">
      <div className="relative z-20 max-w-xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-[#FFE5D9] p-6">
          <h1 className="text-2xl font-bold mb-6 text-[#994D1C] text-center">Projeyi Düzenle</h1>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button disabled={saving} type="submit" className="bg-[#994D1C] text-white px-4 py-2 rounded hover:bg-[#7e3f17] transition block mx-auto">
