          ...
          <div className="mt-6">
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-[#FFB996]" />
              </div>
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-[#6B3416]">
                  {t('auth.otherSignInOptions') || 'Other sign in options'}
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 flex justify-center space-x-4">
              <button
                type="button"
                className="inline-flex items-center justify-center w-10 h-10 rounded-full border border-[#FFB996] shadow-sm bg-white text-sm font-medium text-[#FF8B5E] hover:bg-[#FFF5F0]"
              >
