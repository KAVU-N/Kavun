// Türkiye'deki yaygın bölümler (ve örnekler)
export const departments = [
  ...
  // ... (Tüm bölümler bu şekilde devam edecek, A'dan Z'ye eksiksiz şekilde tamamlanacak)
  ...
  "PSİKOLOJİ(TÜRKÇE)",
  "PSİKOLOJİ(İNGİLİZCE)",
  "ULUSLARARASI TİCARET VE FİNANSMAN(TÜRKÇE)",
