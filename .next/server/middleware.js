...
function p2s(alg, p2sInput) {
    return concat(buffer_utils_encoder.encode(alg), new Uint8Array([
        0
    ]), p2sInput);
}
...
class JWEDecryptionFailed extends (/* unused pure expression or super */ null && (JOSEError)) {
    constructor(){
        super(...arguments);
...
class JWEDecompressionFailed extends (/* unused pure expression or super */ null && (JOSEError)) {
    constructor(){
        super(...arguments);
...
class JWKSNoMatchingKey extends (/* unused pure expression or super */ null && (JOSEError)) {
    constructor(){
        super(...arguments);
...
class JWKSMultipleMatchingKeys extends (/* unused pure expression or super */ null && (JOSEError)) {
    constructor(){
        super(...arguments);
...
class JWKSTimeout extends (/* unused pure expression or super */ null && (JOSEError)) {
    constructor(){
        super(...arguments);
...
async function flattenedVerify(jws, key, options) {
    ...
    const data = concat(buffer_utils_encoder.encode((_a = jws.protected) !== null && _a !== void 0 ? _a : ""), buffer_utils_encoder.encode("."), typeof jws.payload === "string" ? buffer_utils_encoder.encode(jws.payload) : jws.payload);
    let signature;
    try {
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=C%3A%5CUsers%5Ceren%5CKavun%2C%20organization&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2NvdXJzZXMoPzpcXC8oKD86W15cXC8jXFw%2FXSs%2FKSg%2FOlxcLyg%2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9jb3Vyc2VzLzpwYXRoKiJ9XQ%3D%3D&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2NvdXJzZXMoPzpcXC8oKD86W15cXC8jXFw%2FXSs%2FKSg%2FOlxcLyg%2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9jb3Vyc2VzLzpwYXRoKiJ9XX0%3D!
